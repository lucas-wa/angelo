...
export function Main() {
    ...
    return (
        <main className="w-full h-auto flex flex-grow gap-10 py-10 px-16 items-center justify-center">


            <form action="" className="flex-1 items-center justify-center flex flex-col gap-5">
